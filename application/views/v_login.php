    ...
    <body>
        ...
        <div class="container-fluid" style="margin: 4em 0 0 0">
            <div class="row">
                ...
                <div class="col-2">
                    <center>
                        <form class="form-signin" action="<?= site_url('login/coba_login') ?>" method="POST">
                        	<input type="hidden" name="email" value="<?= $email ?>">
                            <img class="mb-4" src="<?= base_url('assets/login.svg') ?>" width="16.5%" height="16.5%">
                            <h1 class="h4 mb-3"><b>Welcome back</b></h1>
                            <h7 style="font-size: 13px; color: #818495;">Please enter your password to log in.</h7>
                            <br><br>
                                    ...
                                    <input type="Password" id="inputEmail" name="pass" class="form-input"required="" autofocus="">
                                    </div>
           
                            <input class="btn btn-lg btn-block" style="background-color: #d1410d; color: white; font-size: 14px" type="submit" onclick="<?= site_url('login/coba_login')  ?>" value="Log In">
                            <a class="nav-link" href="#" style="font-size: 14px;">Forget Password</a>
                        </form>
                    </center>
                </div>
                <div class="col"></div>
