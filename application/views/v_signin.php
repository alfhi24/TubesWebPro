    ...
    <body>
        ...
        <div class="container-fluid" style="margin: 5em 0 0 0">
            <div class="row">
                ...
                <div class="col-2">
                    <center>
                        <form class="form-signin" action="<?= site_url('SignIn/doLogin') ?>" method="POST">
                            <img class="mb-4" src="<?= base_url('assets/icon.png') ?>" width="15%" height="15%">
                            <h1 class="h4 mb-3"><b>Let's get started</b></h1>
                            <h7>Use Facebook or email to get started.</h7>
                            <br><br>
                                <form class="form">
                                    <div class="form-group">
                                        <label for="inputEmail" class="form-label">Email address</label>
                                        <input type="email" id="inputEmail" class="form-input" name="email" required="">
                                    </div>
                                    <input class="btn btn-lg btn-block" style="background-color: #d1410d; color: white; font-size: 15px" type="submit" value="Get Started">
                                </form>
                            ...
                            <br><br>
                            <button class="btn btn-lg btn-block" style="background-color: #4266b2; color: white; font-size: 15px" type="submit" onclick="location.href='https://facebook.com'"><i class="fa fa-facebook-square fa-fw pull-left"></i> Continue with Facebook</button>
                            <br>
                            <p class="mt-7 mb-3 text-muted" style="font-size: 11.5px;"> By continuing, I accept the Eventbrite terms of service, community guidelines and have read the privacy policy.
                            </p>
                        </form>
                    </center>
                </div>
